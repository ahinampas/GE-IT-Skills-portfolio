...
## 📊 Core Focus Areas
- 💻 **Practical Digital Skills:** Learning web technologies, code organization, and version control (using GitHub!).
...
* **Assets:**
  ...
  * ![banner]([./visuals/banner.png](https://github.com/ahinampas/GE-IT-Skills-portfolio/blob/main/Visuals/banner.png))
